...
| [`Docs/User/`](../User/) | Owners | Setup, operation, games (not ROM layout) |
| [`Chassis/Manual/`](../../Chassis/Manual/) | Owners | Archival factory PDF scans |
| [`Docs/Mechanical/`](../Mechanical/) | Repairers | Chassis disassembly, reassembly, teardown photos |
...
| Built-in games (Moon Ball / Force Field) | 4 | `JMP ($0094)` → `$F8CE`; `$F8E9` / `$FAA4` — see Ch 5 + [User Manual Ch 6](../User/06-Games-And-Other-Modes.md) |
