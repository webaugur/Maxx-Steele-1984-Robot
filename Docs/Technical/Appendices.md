...
Player rules: [User Manual Ch 6](../User/06-Games-And-Other-Modes.md). ROM mapping: [Chapter 5 — Game mode](05-Cartridge-Bootstrap-and-Internal-ROM.md#game-mode-4--f8ce).
