...
| [`Docs/Technical/`](../Technical/) | Programmers, reverse engineers | Bytecode, ROM, I/O, cartridge authoring |
| [`Docs/User/`](../User/) | Owners | Setup, operation, games, maintenance (markdown + PDF) |
...
For programming and electrical reference after reassembly, see [`Docs/Technical/README.md`](../Technical/README.md).