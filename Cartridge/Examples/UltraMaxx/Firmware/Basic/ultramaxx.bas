REM UltraMaxx community demo — same 38-step program as CBS factory cart
REM Copyright: (c) UltraMaxx     (only field that differs from CBSDemo.532)
REM
REM Compile:
REM   maxx compile ultramaxx.bas -o ../Binary/UltraMaxx.bas.532 --copyright ultramaxx \
REM     --tables-from ../Binary/UltraMaxx.532
REM
REM Phrase/music tables are byte-identical to CBSDemo; either reference ROM works.
