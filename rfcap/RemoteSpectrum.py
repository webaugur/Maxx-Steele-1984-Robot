...
# Description: Spectrum Analyzer with OOK decoder
...
class RemoteSpectrum(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "RemoteSpectrum")
        ...
        self.rf_gain = rf_gain = 18
        self.recfile = recfile = prefix + datetime.now().strftime("%Y.%m.%d.%H.%M.%S") + ".dat"

        ##################################################
        # Blocks
        ##################################################
        self._tuning_range = Range(26500000, 27500000, 5000, 27095000, 200)
        ...
        self._samp_rate_range = Range(192000, 20000000, 1000, 200000, 200)
        ...
        self._rf_gain_range = Range(0, 100, 1, 18, 200)
        ...
        self._squelch_range = Range(-70, 70, 1, 0, 200)
        ...
        self.osmosdr_source_0.set_if_gain(rf_gain + 10, 0)
        self.osmosdr_source_0.set_bb_gain(rf_gain + 10, 0)
        self.osmosdr_source_0.set_antenna('', 0)
        self.osmosdr_source_0.set_bandwidth(0, 0)
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(50, [1], 1000, samp_rate)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(recfile, 1, samp_rate, 16)
        self.blocks_threshold_ff_1 = blocks.threshold_ff(.015, .015, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_simple_squelch_cc_0, 0), (self.qtgui_time_sink_x_2, 0))
        self.connect((self.blocks_rms_xx_0, 0), (self.blocks_threshold_ff_1, 0))
        self.connect((self.blocks_rms_xx_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_threshold_ff_1, 0), (self.blocks_wavfile_sink_0, 0))
    ...
    def set_rf_gain(self, rf_gain):
        ...
        self.osmosdr_source_0.set_if_gain(self.rf_gain + 10, 0)
        self.osmosdr_source_0.set_bb_gain(self.rf_gain + 10, 0)
...
def main(top_block_cls=RemoteSpectrum, options=None):
